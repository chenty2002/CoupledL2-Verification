...
import coupledL2AsL1.{SinkA => L1SinkA, MainPipe => L1MainPipe}
import coupledL2._
...
class Slice()(implicit p: Parameters) extends L2Module {
  ...
  // val directoryTest = Module(new Directory())
...
//  io.directory_test_metaArray := directoryTest.io.metaArray
//  io.directory_test_tagArray := directoryTest.io.tagArray
