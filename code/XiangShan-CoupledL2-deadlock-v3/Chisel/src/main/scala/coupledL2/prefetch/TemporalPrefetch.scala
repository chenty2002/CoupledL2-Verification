...
class TemporalPrefetch(implicit p: Parameters) extends TPModule {
  ...
  */
  ...
  val triggerDB = ChiselDB.createTable("tptrigger", new triggerBundle(), basicDB = false) // val triggerDB = ChiselDB.createTable("tptrigger", new triggerBundle(), basicDB = debug)
  ...
  val trainDB = ChiselDB.createTable("tptrain", new trainBundle(), basicDB = false) // val trainDB = ChiselDB.createTable("tptrain", new trainBundle(), basicDB = debug)
  ...
  val sendDB = ChiselDB.createTable("tpsend", new sendBundle(), basicDB = false) // val sendDB = ChiselDB.createTable("tpsend", new sendBundle(), basicDB = debug)
