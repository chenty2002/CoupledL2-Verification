...
(
  name: String = "L2",
  ways: Int = 1, // ways: Int = 4,
  sets: Int = 2, // sets: Int = 128,
  blockBytes: Int = 2, // blockBytes: Int = 64,
  pageBytes: Int = 4096,
  channelBytes: TLChannelBeatBytes = TLChannelBeatBytes(1), // channelBytes: TLChannelBeatBytes = TLChannelBeatBytes(32),
